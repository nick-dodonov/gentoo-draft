...
src_unpack() {
	unpack ${P}.tar.gz
	use prql && cargo_src_unpack
}

src_prepare() {
	# cargo isn't executed - it will be executed within make
...
src_compile() {
	...
	use prql && cargo_src_compile --manifest-path src/third-party/prqlc-c/Cargo.toml
